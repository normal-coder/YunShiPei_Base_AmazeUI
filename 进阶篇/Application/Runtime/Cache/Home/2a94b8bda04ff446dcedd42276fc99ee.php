...
<head lang="en">
  ...
  <link rel="alternate icon" type="image/png" href="/yunshipei/Public/Home/i/favicon.png">
  <link rel="stylesheet" href="/yunshipei/Public/Home/css/amazeui.min.css"/>
  <link rel="stylesheet" href="/yunshipei/Public/Home/css/app.css"/>
</head>
<body>
<!-- 手机版侧滑菜单 -->
...
<header class="am-topbar am-topbar-fixed-top">
  <div class="am-container">
    <h1 class="am-topbar-brand">
      <a href="#"><img src="/yunshipei/Public/Home/images/logo.png" /></a>
    </h1>
...
<div class="banner">
  ...
  <div class="homepage-banner-img">
    <img src="/yunshipei/Public/Home/images/banner_img.png" alt=""/>
  </div>
...
<div class="properties-mod module-wrap">
  <div class="am-container">
    <ul class="properties-list am-avg-sm-2 am-avg-md-4">
      <li >
        <img src="/yunshipei/Public/Home/images/properties-img1.jpg" />
        <p>只需插入一行代码</p>
      </li>
      <li >
        <img src="/yunshipei/Public/Home/images/properties-img2.jpg" />
        <p>网址不变</p>
      </li>
      <li>
        <img src="/yunshipei/Public/Home/images/properties-img3.jpg" />
        <p>内容同步更新</p>
      </li>
      <li>
        <img src="/yunshipei/Public/Home/images/properties-img4.jpg" />
        <p>云端加速</p>
      </li>      
    </ul>
  </div>
  ...
  <div class="am-container">
    ...
    <div class="intro-list am-g">
      <div class="am-u-md-6 am-u-sm-12 intro-img">
        <img src="/yunshipei/Public/Home/images/intro-img1.png" />
      </div>
    ...
    <div class="intro-list am-g">
      <div class="am-u-md-6 am-u-sm-12 intro-img">
        <img src="/yunshipei/Public/Home/images/intro-img2.png" />
      </div>
    ...
    <div class="intro-list am-g">
      <div class="am-u-md-6 am-u-sm-12 intro-img">
        <img src="/yunshipei/Public/Home/images/intro-img3.png" />
      </div>
...
<footer>
  <div class="am-container">
    <div class="footer-logo">
      <img src="/yunshipei/Public/Home/images/logo-colorful.png" />
    </div>
...
<div class="weixin-mod">
  <div class="weixin-inner">
    ...
    <div class="qrcode-weixin">
      <img src="/yunshipei/Public/Home/images/qrcode-weixin.jpg" alt="">
    </div>
...
<script src="/yunshipei/Public/Home/js/polyfill/rem.min.js"></script>
<script src="/yunshipei/Public/Home/js/polyfill/respond.min.js"></script>
<script src="/yunshipei/Public/Home/js/amazeui.legacy.js"></script>
<![endif]-->
<!--[if (gte IE 9)|!(IE)]><!-->
<script src="/yunshipei/Public/Home/js/jquery.min.js"></script>
<script src="/yunshipei/Public/Home/js/amazeui.min.js"></script>
<script src="/yunshipei/Public/Home/js/app.js"></script>
<!--<![endif]-->
</html>